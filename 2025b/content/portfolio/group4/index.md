...
- Front-end: ReactJS, JavaScript, HTML, Leaflet
- Back-end: Python, Flask, API Tainacan, Gemini
- Deploy: Vercel (front) / Render (back)

##### Repositórios

- Frontend: https://github.com/elc1074/trajeto-cultural-frontend
- Backend: https://github.com/elc1074/trajeto-cultural-backend
...
- Dionatan Eduardo Correa Rodrigues (SI / UFSM)
- Gabriel Marquezan Pozzati da Luz (CC / UFSM)
